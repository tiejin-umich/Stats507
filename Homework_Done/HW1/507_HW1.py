...
for method in method_list:
    ...
    if method == 'Norm_theory':
        for n in n_list:
            ...
            new_lwr_key = str(n)+'_lwr'
            new_upr_key = str(n)+'_upr'
            new_width_key = str(n)+'_width'
            dict_all[method][new_lwr_key] = temp_dict['lwr']
            dict_all[method][new_upr_key] = temp_dict['upr']
            dict_all[method][new_width_key] = temp_dict['upr']-temp_dict['lwr']
    else:
        for n in n_list:
            ...
            dict_all[method][new_upr_key] = temp_dict['upr']
            dict_all[method][new_width_key] = temp_dict['upr']-temp_dict['lwr']
table_all = pd.DataFrame(dict_all).T
